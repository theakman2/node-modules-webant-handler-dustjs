...
(function(dust) {
    ...
    function body_0(chk, ctx) {
        return chk.f(ctx.get([ "name" ], false), ctx, "h").w(" m ").p("__WEBANT_DUST_2__", ctx, ctx, {}).w(" n ").p("__WEBANT_DUST_2__", ctx, ctx, {}).w(" o ").p("__WEBANT_DUST_6__", ctx, ctx, {}).w(" ").f(ctx.get([ "age" ], false), ctx, "h");
    }
    body_0.__dustBody = !0;
    return body_0;
})(dust);
...
(function(dust) {
    ...
    function body_0(chk, ctx) {
        return chk.w("r ").p("__WEBANT_DUST_4__", ctx, ctx, {}).w(" s ").p("__WEBANT_DUST_3__", ctx, ctx, {
            name2: "foo"
        }).w(" t");
    }
    body_0.__dustBody = !0;
...
(function(dust) {
    ...
    function body_0(chk, ctx) {
        return chk.w("p ").p("__WEBANT_DUST_3__", ctx, ctx, {
            name2: "bar"
        }).w(" q");
    }
    body_0.__dustBody = !0;
...
(function(dust) {
    ...
    function body_0(chk, ctx) {
        ...
        return chk.p("__WEBANT_DUST_5__", ctx, ctx, {});
    }
    body_0.__dustBody = !0;
...
(function(dust) {
    ...
    function body_0(chk, ctx) {
        return chk.w("a ").b(ctx.getBlock("foo"), ctx, {}, {}).w(" b ").b(ctx.getBlock("bar"), ctx, {}, {});
    }
    body_0.__dustBody = !0;
    return body_0;
})(dust);
...
(function(dust) {
    ...
    function body_0(chk, ctx) {
        return chk.w("u ").p("__WEBANT_DUST_4__", ctx, ctx, {}).w(" v ").f(ctx.get([ "name2" ], false), ctx, "h").w("w");
    }
    body_0.__dustBody = !0;
    return body_0;
})(dust);
...
window.__global = require([ "main.js", "8" ])({
    name: "Bob",
    age: "thirty"
});

window.__global += Object.keys(require([ "main.js", "2" ]).cache).length;
